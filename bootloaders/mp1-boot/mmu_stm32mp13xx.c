...
void MMU_CreateTranslationTable(void)
{
  ...
  MMU_TTPage4k (ttb_addr, SYSRAM_BASE                      , 256U/4U , Page_L1_4k, (uint32_t *)sysram_table_l2_base_4k, Page_4k_Normal_RW_NonCacheable);
  ...
  else
  {
    ...
    MMU_TTPage4k (ttb_addr, SYSRAM_BASE                      , 256U/4U,  Page_L1_4k, (uint32_t *)code_and_data_table_l2_base_4k, Page_4k_Normal_RW_NonCacheable);
